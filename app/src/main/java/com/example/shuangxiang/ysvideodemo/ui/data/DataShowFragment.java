...
public class DataShowFragment extends BaseFragment implements ISettingParameterV {
    ...
    protected void initData() {
        ...
        Log.d("TEST", "mFirstInto="+mFirstInto);
        Log.d("TEST", String.valueOf("mSettingParameterP="+mSettingParameterP==null));
    ...
    public void setRvData(final List<String> names, final List<String> values, List<String> ids,
        ...
        if (names != null && names.size() > 0 && values != null && values.size() > 0 && ids != null && ids.size()
            ...
            if (mFirstInto) {
                ...
                Log.d("TEST", "dataShow_refresh4");
            } else {
                mAdapterBottom.setValues(values);
                Log.d("TEST", "ok");
            }
        } else {
            Log.d("TEST", "dataShow_refresh3");
            if (mFirstInto) {
    ...
    public void dismissDialog() {
        Log.d("TEST", "dataShow_refresh5");
        Log.d("TEST", "isShowing=" + mProgressDialog.isShowing());
